...
```bash
# What is installed. Nothing is ever installed for you.
python3 scripts/external_adapters.py --availability

# Import a result you already have
