...
FRAMEWORK_PROVENANCE = {
    ...
    "reviewed_by": "vibecheck maintainers",
...
FOCUS_FRAMEWORK_PROVENANCE = {
    "source": "curated subset of the vibecheck_v1 checklist for a non-technical owner go/no-go review (sample second framework)",
    "established_at": "2026-08-16T00:00:00Z",
